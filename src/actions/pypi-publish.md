...
github_url: "https://github.com/pypa/gh-action-pypi-publish"
author: "pypa"
subtitle: "GitHub Action for publishing pre-build distribution packages to PyPI (from `dist/` dir)"
tags: ["github-action","python","workflow","workflow-automation","pypi","python-packaging","twine","secrets","upload","release","release-automation","release-helper","workflows","github-actions"]
---
